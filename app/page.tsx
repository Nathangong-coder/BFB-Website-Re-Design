      ...
      <section id="apply" className="relative order-3 lap:order-none py-section px-gutter overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/recruitment"
              className="inline-flex items-center justify-center min-h-[52px] px-11 py-4 bg-bfb-blue text-white font-bold rounded-sm hover:bg-bfb-blue/90 transition-all duration-300 hover:-translate-y-1 shadow-lg shadow-bfb-blue/20 w-full sm:w-auto"
            >
              Students
            </Link>
            <Link
              href="/clients"
              className="inline-flex items-center justify-center min-h-[52px] px-11 py-4 border border-bfb-blue text-bfb-blue dark:text-accent font-bold rounded-sm hover:bg-bfb-blue/5 dark:hover:bg-accent/5 transition-all duration-300 hover:-translate-y-1 w-full sm:w-auto"
            >
              Clients
            </Link>
          </div>
